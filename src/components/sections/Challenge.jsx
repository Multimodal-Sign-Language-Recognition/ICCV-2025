...
const Challenge = () => {
    return (
        <SectionWrapper id="challenge-internal" title="SignEval 2025: The First Multimodal Sign Language Recognition Challenge" subtitle="Push the Boundaries" bgColor="bg-white">
            <motion.p
